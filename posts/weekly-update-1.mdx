...
The major project this week has been the rebuild of my personal website (this site). Previously, it was a simple Gatsby starter, while most of my other projects use [Next.js](https://nextjs.org/). By migrating this to Next.js has allowed use my existing knowledge, share code between projects and alleviate any context switching issues.
